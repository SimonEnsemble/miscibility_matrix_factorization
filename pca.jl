...
# ╔═╡ b8220ec2-446c-4121-b229-af5f8906ef7e
# visualization
begin
	A = convert(Matrix{Float64}, df) 
	
	heatmap(A; 
	axis=(;xlabel = "Compound ID",ylabel = "Compound ID", title = "Pairwise miscibility data")) 
	 
	#Legend(fig, hm, ["ble", "red"])
end

# ╔═╡ 4fbb155e-c508-41f2-aca6-d1b6a9123813
begin
	# normalization
	for i = 1:n
		if std(A[i, :]) != 0
...
# ╔═╡ b78bd15f-0818-4383-a2b3-65c2a9f72d5f
begin
	figure(figsize=(9, 9))
	
	PyPlot.scatter(Y[1, :], Y[2, :], edgecolor="k", c=compounds[:, :ATPS_frac], marker="D", cmap="gist_rainbow")
